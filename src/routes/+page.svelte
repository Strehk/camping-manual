...
<div class="mt-8 grid w-full grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-10">
	<Card.Root class="w-full">
		...
		<Card.Footer>
			<Button.Root href="/mission">Zu den Missionen</Button.Root>
		</Card.Footer>
	</Card.Root>
	<Card.Root class="w-full">
		<Card.Content>
		...
		<Card.Footer>
			<Button.Root href="/sequence">Sequenzen durchsuchen</Button.Root>
		</Card.Footer>
	</Card.Root>
	<Card.Root class="w-full">
		<Card.Content>
			<h2 class="text-2xl font-bold">Checklisten</h2>
			<p>Listen zum Abhaken</p>
		</Card.Content>
		<Card.Footer>
			<Button.Root href="/checklist">Listen durchsuchen</Button.Root>
		</Card.Footer>
	</Card.Root>
</div>
